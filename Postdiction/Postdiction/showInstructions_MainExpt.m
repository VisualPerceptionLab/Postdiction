...
text = 'Thank you for participating in our study!\n\nIn this study you will be asked to report on the number of visual flashes you perceive while hearing simultaneous sounds. ';
text = [text 'Each trial will start with a fixation point, which will be presented in the middle of the screen. It is important that you keep your eyes fixated on this point. '];
...
text = [text 'For indicating how confident you are in your response, please use "r" (very confident), "e" (quite confident), "w" (not so confident)", "q" (not confident at all). Please place the four fingers of the left hand on "qwer". You have one second to respond to each question.\n\n'];
...
text = [text 'If no answer is given for either question, the fixation point will flicker to make you aware of the missed answer. Be aware that the response window is quite short, so make sure to respond quickly.\n\n'];
...
DrawFormattedText(window, text, 50 , 'center', 0, wrapat,0,0,vspacing);
Screen('Flip',window);
WaitSecs(1);
FlushEvents('keyDown');

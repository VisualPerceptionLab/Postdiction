...
text = [text 'For indicating how confident you are in your response, please use "r" (very confident), "e" (quite confident), "w" (not so confident)", "q" (not confident at all). Please place the four fingers of the left hand on "qwer". (1/2)\n\n'];
...
text = 'You have two seconds to respond to both questions. Please first indicate how many flashes you saw, and then the confidence in your answer. If you see a flash, but it is not very clear, it still counts as a flash but with less  \n\n';
...
%What the task is like
text = 'Okay great, two blocks of 32 practice trials will start now!';

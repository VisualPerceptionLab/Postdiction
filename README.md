...
### Understanding hallucinations: the Micromanaging Executive analogy
We distilled millions of brain activity data points to a few hundred for 24 participants through experiment, literature and brain tissue analysis. This information showed us that hallucination perception is no livestream, but a post-hoc reconstructed **hallucination** from **faulty** top-down signalling. **Imagine the brain as a corporation**. It works like a classic corporate disconnect: The **'Specialist'** (visual cortex) has the correct data, but the **'Manager'** receives the report (for example,  frontal cortex) and sometimes overrides them based on a gut feeling from experience and input from other 'Specialists'. Our research shows that hallucinations in the human brain come from the Manager becoming a **Micromanager**: correcting when they're wrong. We are now preparing to publish this important evidence on our brain's reality in a **high impact journal**. This finding can directly be applied to how the hierarchy of **AI neural networks** lead to **hallucinations**, and I am eager to explore that question in the future.
